const translations: any = {
  ...
  "HELP_LIQUIDITY": {
    "EN": "Adding liquidity is the action of supplying both XXX and TON to allow others to swap between them. For every swap you will earn 0.3% fees + additional 30% rewards APR. There is always a risk of impermanent loss so it is advised to learn about it before supplying liquidity. Remove liquidity is the action of getting back the XXX and TON you already supplied before.",
    "RU": "Добавление ликвидности — это действие по предоставлению как XXX, так и TON, чтобы позволить другим обмениваться ими. За каждый своп вы будете получать комиссию в размере 0,3% + дополнительные вознаграждения в размере 30% годовых. Всегда существует риск непоправимой потери, поэтому рекомендуется узнать об этом до предоставления ликвидности. Удаление ликвидности — это действие по возврату XXX и TON, которые вы уже предоставили ранее"
  },
  "MANAGE_LIQUIDITY": {
    "EN": "Add liquidity by depositing both XXX and TON to earn rewards of up to 30% APR (yearly interest) or remove liquidity to withdraw your XXX and TON back to your wallet XXX and TON to earn rewards",
    "RU": "Bы можете добавить ликвидность, внося депозиты как XXX, так и TON, чтобы получить вознаграждение до 30% годовых (годовые проценты), или удалите ликвидность, чтобы вывести XXX и TON обратно в свой кошелек XXX и TON, чтобы получить вознаграждение"
  },
  "REMOVE_LIQUIDITY": {
  ...
  "buttons": {
    ...
    "SELECT_CUSTOM_TOKEN": {
      "EN": "Custom token address",
      "RU": "Пользовательский адрес токена"
    }
  }
}
